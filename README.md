...
　　在上數學課的時候，到了微分的單元，老師講述到關於泰勒展開式時，有提及三角函數 sinx 及 cosx 在 x 趨近於 0 時的泰勒展開式，很有趣，但沒有詳加介紹，好奇心驅使了我，想知道如果用程式去執行的結果，所以便有了自己動手實作的想法。
## 二、泰勒展開式
...
由於 sinx 和 cosx 的週期為 2π ，故後來我將在範圍外之 x，以同位角換算成範圍內，再進行計算，以達到能夠計算廣義角的功能。
...
程式的學習，好似在製作一台時光機，可乘坐著它去過去的任何年代，領略那些先知哲人的偉大創作，更期待在更深更廣的學習精進下，能夠成為我通往未來，創造屬於我們的這一代的最佳工具。
